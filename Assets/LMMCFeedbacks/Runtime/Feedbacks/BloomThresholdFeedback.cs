...
{
    [Serializable] public class BloomThresholdFeedback : IFeedback, IFeedbackTagColor, IFeedbackSceneRepaint, IFeedbackInitializable
    {
        ...
        {
            if (_bloomCache != null) _bloomCache.threshold.Override(initialIntensity);
        }
